...
const trackBookConsultation = () => {
  var _a2;
  (_a2 = window.gtag) == null ? void 0 : _a2.call(window, "event", "book_consultation_click", {
...
const trackQuoteFormSubmission = (platforms, source_page) => {
  var _a2;
  (_a2 = window.gtag) == null ? void 0 : _a2.call(window, "event", "quote_form_submission", {
    platforms,
    source_page
  });
};
const trackPhoneClick = () => {
  var _a2;
  (_a2 = window.gtag) == null ? void 0 : _a2.call(window, "event", "phone_click", {
    event_category: "conversion",
...
const trackGetStartedClick = () => {
  var _a2;
  (_a2 = window.gtag) == null ? void 0 : _a2.call(window, "event", "get_started_click", {
    event_category: "conversion",
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxs("ul", { className: "space-y-2 text-sm", children: [
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("button", { onClick: () => {
            var _a2;
            return (_a2 = document.getElementById("services")) == null ? void 0 : _a2.scrollIntoView({
              behavior: "smooth"
            });
          }, className: "text-primary-foreground/80 hover:text-primary-foreground transition-colors", children: "Services" }) }),
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("button", { onClick: () => {
            var _a2;
            return (_a2 = document.getElementById("about")) == null ? void 0 : _a2.scrollIntoView({
              behavior: "smooth"
            });
          }, className: "text-primary-foreground/80 hover:text-primary-foreground transition-colors", children: "About Us" }) }),
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("button", { onClick: () => {
            var _a2;
            return (_a2 = document.getElementById("contact")) == null ? void 0 : _a2.scrollIntoView({
              behavior: "smooth"
            });
  ...
  const handleSubmit = async (e) => {
    ...
    if (!parsed.success) {
      toast2({
        ...
        description: ((_b2 = parsed.error.issues[0]) == null ? void 0 : _b2.message) ?? "Invalid input",
        variant: "destructive"
      });
      return;
    }
