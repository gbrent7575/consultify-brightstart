...
const leadSchema = z$1.object({
  name: z$1.string().trim().min(1, { message: "Name is required" }).max(100),
  company: z$1.string().trim().min(1, { message: "Company is required" }).max(100),
  email: z$1.string().trim().email({ message: "Invalid email address" }).max(255),
  phone: z$1.string().trim().min(1, { message: "Phone is required" }).max(20),
  platforms: z$1.string().min(1, { message: "Please select platforms needed" })
});
...
const schema = z$1.object({
  name: z$1.string().trim().min(1, "Name is required").max(100),
  company: z$1.string().trim().min(1, "Company is required").max(150),
  email: z$1.string().trim().email("Invalid email").max(255),
  phone: z$1.string().trim().min(7, "Phone is required").max(30),
  platform: z$1.string().min(1, "Please select a platform"),
  message: z$1.string().max(2e3).optional()
});
const IsnQuoteForm = ({
  defaultPlatform = "",
  ...
  const update = (k2, v2) => setForm((p2) => ({ ...p2, [k2]: v2 }));
  const handleSubmit = async (e) => {
    var _a, _b;
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-2 gap-4", children: [
          ...
          !defaultPlatform && /* @__PURE__ */ jsxs("div", { className: "md:col-span-2", children: [
            ...
            /* @__PURE__ */ jsxs(Select, { value: form.platform, onValueChange: (v2) => update("platform", v2), children: [
              /* @__PURE__ */ jsx(SelectTrigger, { id: "platform", children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "Select a platform" }) }),
              /* @__PURE__ */ jsx(SelectContent, { children: PLATFORMS.map((p2) => /* @__PURE__ */ jsx(SelectItem, { value: p2, children: p2 }, p2)) })
            ] })
          ] }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "min-h-screen flex flex-col", children: [
      ...
      /* @__PURE__ */ jsxs("main", { className: "flex-grow", children: [
        ...
        /* @__PURE__ */ jsx("section", { className: "py-16 bg-background", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-2 lg:grid-cols-3 gap-6", children: whatWeDo$2.map((item, i2) => /* @__PURE__ */ jsx(Card, { className: "h-full", children: /* @__PURE__ */ jsxs(CardContent, { className: "pt-6", children: [
        ...
        /* @__PURE__ */ jsx("section", { className: "py-16 bg-muted/30", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-2 gap-6 max-w-5xl mx-auto", children: problems$2.map((p2, i2) => /* @__PURE__ */ jsx(Card, { className: "h-full", children: /* @__PURE__ */ jsxs(CardContent, { className: "pt-6", children: [
            /* @__PURE__ */ jsxs("p", { className: "font-bold text-lg mb-3 text-primary", children: [
              '"',
              p2.problem,
              '"'
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-muted-foreground", children: p2.answer })
          ] }) }, i2)) })
        ] }) }),
        /* @__PURE__ */ jsx("section", { className: "py-16 bg-background", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
          ...
          ].map((b2, i2) => /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
            /* @__PURE__ */ jsx(CheckCircle2, { className: "text-accent w-6 h-6 flex-shrink-0 mt-1" }),
            /* @__PURE__ */ jsx("p", { className: "text-lg", children: b2 })
          ] }, i2)) }),
        ...
        /* @__PURE__ */ jsx("section", { className: "py-16 bg-muted/30", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "max-w-3xl mx-auto", children: /* @__PURE__ */ jsx(Accordion, { type: "single", collapsible: true, className: "w-full", children: faqs$2.map((f2, i2) => /* @__PURE__ */ jsxs(AccordionItem, { value: `item-${i2}`, children: [
            /* @__PURE__ */ jsx(AccordionTrigger, { className: "text-left text-lg font-semibold", children: f2.q }),
            /* @__PURE__ */ jsx(AccordionContent, { className: "text-base text-muted-foreground", children: f2.a })
          ] }, i2)) }) })
        ] }) }),
        /* @__PURE__ */ jsx(
          "section",
    ...
    /* @__PURE__ */ jsxs("div", { className: "min-h-screen flex flex-col", children: [
      ...
      /* @__PURE__ */ jsxs("main", { className: "flex-grow", children: [
        ...
        /* @__PURE__ */ jsx("section", { className: "py-16 bg-background", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
          ...
          /* @__PURE__ */ jsx("ol", { className: "max-w-3xl mx-auto space-y-4", children: whatWeDo$1.map((item, i2) => /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-4", children: [
            /* @__PURE__ */ jsx("span", { className: "flex-shrink-0 w-9 h-9 rounded-full bg-accent text-accent-foreground font-bold flex items-center justify-center", children: i2 + 1 }),
        ...
        /* @__PURE__ */ jsx("section", { className: "py-16 bg-muted/30", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-2 gap-6 max-w-5xl mx-auto", children: problems$1.map((p2, i2) => /* @__PURE__ */ jsx(Card, { className: "h-full", children: /* @__PURE__ */ jsxs(CardContent, { className: "pt-6", children: [
            /* @__PURE__ */ jsxs("p", { className: "font-bold text-lg mb-3 text-primary", children: [
              '"',
              p2.problem,
              '"'
        ...
        /* @__PURE__ */ jsx("section", { className: "py-16 bg-muted/30", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
          /* @__PURE__ */ jsx("h2", { className: "text-3xl font-bold mb-12 text-center", children: "Frequently Asked Questions" }),
          /* @__PURE__ */ jsx("div", { className: "max-w-3xl mx-auto", children: /* @__PURE__ */ jsx(Accordion, { type: "single", collapsible: true, className: "w-full", children: faqs$1.map((f2, i2) => /* @__PURE__ */ jsxs(AccordionItem, { value: `item-${i2}`, children: [
            /* @__PURE__ */ jsx(AccordionTrigger, { className: "text-left text-lg font-semibold", children: f2.q }),
            /* @__PURE__ */ jsx(AccordionContent, { className: "text-base text-muted-foreground", children: f2.a })
          ] }, i2)) }) })
        ] }) }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "min-h-screen flex flex-col", children: [
      ...
      /* @__PURE__ */ jsxs("main", { className: "flex-grow", children: [
        ...
        /* @__PURE__ */ jsx("section", { className: "py-16 bg-background", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
          ...
          /* @__PURE__ */ jsx("ol", { className: "max-w-3xl mx-auto space-y-4", children: whatWeDo.map((item, i2) => /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-4", children: [
            /* @__PURE__ */ jsx("span", { className: "flex-shrink-0 w-9 h-9 rounded-full bg-accent text-accent-foreground font-bold flex items-center justify-center", children: i2 + 1 }),
            /* @__PURE__ */ jsx("p", { className: "text-lg pt-1", children: item })
          ] }, i2)) })
        ] }) }),
        /* @__PURE__ */ jsx("section", { className: "py-16 bg-muted/30", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-2 gap-6 max-w-5xl mx-auto", children: problems.map((p2, i2) => /* @__PURE__ */ jsx(Card, { className: "h-full", children: /* @__PURE__ */ jsxs(CardContent, { className: "pt-6", children: [
            /* @__PURE__ */ jsxs("p", { className: "font-bold text-lg mb-3 text-primary", children: [
              '"',
              p2.problem,
              '"'
        ...
        /* @__PURE__ */ jsx("section", { className: "py-16 bg-muted/30", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
          /* @__PURE__ */ jsx("h2", { className: "text-3xl font-bold mb-12 text-center", children: "Frequently Asked Questions" }),
          /* @__PURE__ */ jsx("div", { className: "max-w-3xl mx-auto", children: /* @__PURE__ */ jsx(Accordion, { type: "single", collapsible: true, className: "w-full", children: faqs.map((f2, i2) => /* @__PURE__ */ jsxs(AccordionItem, { value: `item-${i2}`, children: [
            /* @__PURE__ */ jsx(AccordionTrigger, { className: "text-left text-lg font-semibold", children: f2.q }),
            /* @__PURE__ */ jsx(AccordionContent, { className: "text-base text-muted-foreground", children: f2.a })
          ] }, i2)) }) })
        ] }) }),
