...
const QuoteForm = () => {
  ...
  const handleSubmit = async (e?: React.FormEvent | React.MouseEvent) => {
    ...
    try {
      ...
      setForm({ name: "", company: "", phone: "", email: "", platform: "ISNetworld", referral_source: "" });
    } catch (err) {
      toast({
  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col bg-background">
        {/* Thin orange announcement bar */}
        <div className="w-full bg-accent text-accent-foreground py-2 px-4 text-center text-sm font-medium">
          ISNetworld® Compliance Help — Talk to a specialist today
        </div>

        {/* Minimal header: logo left, phone right */}
        ...
        <main className="flex-grow pb-20 md:pb-0">
              ...
              <div className="grid lg:grid-cols-2 gap-10 items-start">
                <div>
                  ...
                  <ul className="space-y-3 mt-4">
                    {[
                      "Recover a failing or rejected ISNetworld grade",
                      "Done-for-you paperwork — MSQ, RAVS, OSHA logs, COIs",
          ...
          {/* 5 things that drive your ISNetworld score */}
          ...
          <section className="py-16 md:py-20 bg-primary text-primary-foreground text-center">
            <div className="container mx-auto px-4 max-w-3xl">
              ...
              <p className="text-xs text-primary-foreground/70 mt-6">
                ISNetworld® is a registered trademark of ISN Software Corporation. Cornerstone Risk Management is not endorsed by or affiliated with ISN Software Corporation.
              </p>
            </div>
          </section>
        </main>
