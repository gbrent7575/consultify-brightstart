...
export const routes: RouteRecord[] = [
  {
    ...
    children: [
      ...
      { path: "isnetworld-help", element: <Navigate to="/isn/help" replace /> },
      { path: "isnetworld", element: <Navigate to="/isn/help" replace /> },
      { path: "isn", element: <Navigate to="/isn/help" replace /> },
      { path: "avetta-help", element: <Avetta />, entry: "src/pages/Avetta.tsx" },
      { path: "avetta", element: <Navigate to="/avetta-help" replace /> },
      { path: "avetta/help", element: <Navigate to="/avetta-help" replace /> },
      ...
      { path: "veriforce", element: <Navigate to="/veriforce-help" replace /> },
      { path: "veriforce/help", element: <Navigate to="/veriforce-help" replace /> },
